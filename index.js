...
mongoose.connect('mongodb+srv://admin:1234@cluster0.iu2beqk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', {
    useNewUrlParser: true, // ใช้ URL parser ใหม่ของ mongoose
});
...
app.set('view engine', 'ejs'); // กำหนดให้ express ใช้ ejs เป็น template engine โดยใช้ method set ของ express ซึ่งใช้ set เพื่อกำหนดค่าต่าง ๆ ของ express
